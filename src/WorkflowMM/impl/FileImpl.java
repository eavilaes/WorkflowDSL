...
public class FileImpl extends MinimalEObjectImpl.Container implements File {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowMMPackage.FILE__ID, oldId, id));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkflowMMPackage.FILE__PATH, oldPath, path));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WorkflowMMPackage.FILE__ID:
				return getId();
