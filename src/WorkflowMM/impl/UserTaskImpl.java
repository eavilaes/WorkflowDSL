 ...
 * </p>
 * <ul>
 *   <li>{@link WorkflowMM.impl.UserTaskImpl#getRequires <em>Requires</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserTaskImpl extends TaskImpl implements UserTask {
	...
	public EList<Information> getRequires() {
		if (requires == null) {
			requires = new EObjectResolvingEList<Information>(Information.class, this, WorkflowMMPackage.USER_TASK__REQUIRES);
		}
		return requires;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WorkflowMMPackage.USER_TASK__REQUIRES:
				return getRequires();
		}
